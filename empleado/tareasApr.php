                ...
                <div class="tab-pane fade show active" id="nav-solicitudes" role="tabpanel"
                    ...
                    <div class="row">
                        <div class="col-12  border rounded p-3">
                            <h5 class="card-title text-center mt-4"><b>Tareas Por Aprobar</b></h5>
                            <div class="col-12">
                                <form action="" class="form-group" id="iniciarTarea">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div id="tareasAprobar" class="mt-3"></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form action="" class="form-group" id="buscar1">
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control inicialM" rows="2"
                                    ...
                                    <form class="form-group" id="buscar12"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" id="fileTarea"
