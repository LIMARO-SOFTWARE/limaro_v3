            ...
            datos += "<table id='tableDocumentoVigentesEmp'  class='table  table-striped table-bordered table-responsive '   >";
               datos += '<thead >';
                    datos += '<tr class="table-light border-primary ">';
                      	datos += '<th  class="text-center align-middle border border-primary " hidden >MACROPROCESO</th>';
						...
						datos += '<th  class="text-center align-middle border border-primary " hidden >PROCESOS</th>';
                    datos += '</tr>';
                datos +=  '</thead>';
                datos += '<tbody>';
                    $.each(json, function(key, value){
                        datos += '<tr class="align-middle" >';
                         	...
                         	datos += '<td class=" border border-primary  text-wrap" hidden>' + value.macroproceso + '</td>';
...
datos += '<td class=" border border-primary  text-wrap" hidden> Proceso: '+ value.proceso +' </td>';
                        datos += '</tr>';
                    });
                datos += '</tbody>';
            datos += '</table>';
  ...
  var collapsedGroups = {};
    ...
    $('#example tbody').on('click', 'tr.dtrg-start', function () {
        var name = $(this).data(value.macroproceso);
